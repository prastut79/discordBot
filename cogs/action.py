...
class Action(commands.Cog):
    ...
    def get_url(self, query, description):
        ...
        info = r.json()
        embed = discord.Embed(
            description=description, color=random.choice(self.bot.hex_colors)
        )
    ...
    async def gasm(self, ctx, user: discord.Member = None):
        """Gasm Someone."""
        description = (
            f"{ctx.author.mention} just Gasmed {user.mention if user else 'Himself'}"
        )
    ...
    async def poke(self, ctx, user: discord.Member = None):
        """Poke Someone."""
        description = (
            f"{ctx.author.mention} just Pokeed {user.mention if user else 'Himself'}"
        )
    ...
    async def slap(self, ctx, user: discord.Member = None):
        """Slap Someone."""
        description = (
            f"{ctx.author.mention} just Slaped {user.mention if user else 'Himself'}"
        )
    ...
    async def waifu(self, ctx, user: discord.Member = None):
        """Waifu Someone."""
        description = (
            f"{ctx.author.mention} just Waifued {user.mention if user else 'Himself'}"
        )
    ...
    async def pat(self, ctx, user: discord.Member = None):
        """Pat Someone."""
        description = (
            f"{ctx.author.mention} just Pated {user.mention if user else 'Himself'}"
        )
    ...
    async def neko(self, ctx, user: discord.Member = None):
        """Neko Someone."""
        description = (
            f"{ctx.author.mention} just Nekoed {user.mention if user else 'Himself'}"
        )
    ...
    async def spank(self, ctx, user: discord.Member = None):
        """Spank Someone."""
        description = (
            f"{ctx.author.mention} just Spanked {user.mention if user else 'Himself'}"
        )
    ...
    async def cuddle(self, ctx, user: discord.Member = None):
        """Cuddle Someone."""
        description = (
            f"{ctx.author.mention} just Cuddleed {user.mention if user else 'Himself'}"
        )
    ...
    async def hug(self, ctx, user: discord.Member = None):
        """Hug Someone."""
        description = (
            f"{ctx.author.mention} just Huged {user.mention if user else 'Himself'}"
        )
    ...
    async def smug(self, ctx, user: discord.Member = None):
        """Smug Someone."""
        description = (
            f"{ctx.author.mention} just Smuged {user.mention if user else 'Himself'}"
        )
    ...
    async def baka(self, ctx, user: discord.Member = None):
        """Baka Someone."""
        description = (
            f"{ctx.author.mention} just Bakaed {user.mention if user else 'Himself'}"
        )
    ...
    async def woof(self, ctx, user: discord.Member = None):
        """Woof Someone."""
        description = (
            f"{ctx.author.mention} just Woofed {user.mention if user else 'Himself'}"
        )
